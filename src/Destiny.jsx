...
function Destiny(props) {
  return (
    <div class="w-[100vw] h-[62%] p-[10px] flex">
        ...
        <div class="w-[50%] h-full flex relative text-white">
          <div>
            <span class="text-8xl absolute top-[7%] left-[5%]">{props.name}</span>
            <span class="text-xl absolute top-[35%] left-[4%] right-[20%]">{props.description}</span>
          </div>
          <div class="w-[80%] h-[1.5px] absolute top-[72%] left-[4%] bg-white"></div>
          <div class="absolute top-[75%] flex w-full h-[20%]">
